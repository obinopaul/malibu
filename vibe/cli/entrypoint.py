...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Malibu interactive CLI")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "or custom from ~/.malibu/agents/NAME.toml)",
    )
...
def check_and_resolve_trusted_folder() -> None:
    try:
        ...
        rprint(
            ...
            "[yellow]The directory you started Malibu from has been deleted. "
