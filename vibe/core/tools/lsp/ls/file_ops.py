...
from vibe.core.tools.lsp.ls_utils import FileUtils, TextUtils
from vibe.core.tools.lsp.lsp_protocol_handler.lsp_constants import (
    LSPConstants,
)
from vibe.core.tools.lsp.util.compat import MatchedConsecutiveLines

if TYPE_CHECKING:
    from vibe.core.tools.lsp.ls.server import LSPFileBuffer
