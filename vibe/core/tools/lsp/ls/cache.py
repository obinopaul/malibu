...
class CacheMixin:
    ...
    def _save_raw_document_symbols_cache(self) -> None:
        from vibe.core.tools.lsp.util.cache import save_cache
    ...
    def _load_raw_document_symbols_cache(self) -> None:
        from vibe.core.tools.lsp.util.cache import load_cache
        from vibe.core.tools.lsp.util.compat import load_pickle
