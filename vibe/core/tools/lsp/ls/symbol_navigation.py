...
from vibe.core.tools.lsp.ls_utils import FileUtils
from vibe.core.tools.lsp.lsp_protocol_handler import lsp_types as LSPTypes

if TYPE_CHECKING:
    from vibe.core.tools.lsp.ls.server import LSPFileBuffer, ReferenceInSymbol
...
class SymbolNavigationMixin:
    ...
    def request_referencing_symbols(
        ...
        """
        from vibe.core.tools.lsp.ls.server import ReferenceInSymbol
