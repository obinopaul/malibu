...
if TYPE_CHECKING:
    from vibe.core.context_engineering.history import SessionManager
    from vibe.core.context_engineering.memory import Playbook
    from vibe.core.context_engineering.tools.implementations import FileOperations
