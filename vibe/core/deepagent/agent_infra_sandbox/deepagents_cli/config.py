...
# Exception for force exit (moved from autoglm_middleware)
class ForceExitException(Exception):
    """Exception raised when user forces exit (e.g., second Ctrl+C)."""
    pass
...
COLORS = {
    ...
    "dim": "#6b7280",
    "user": "#ffffff",
    "agent": "#a78bfa",    # Light Violet
    "thinking": "#c084fc", # Lighter Violet
    "tool": "#fbbf24",
}
...
class Settings:
    ...
    - File system paths
    - AutoGLM configuration for Android device automation
    ...
    # Agent-Infra Sandbox configuration
    agent_infra_url: str
    agent_infra_timeout: float
    ...
    def from_environment(cls, *, start_path: Path | None = None) -> "Settings":
        ...
        # Load Agent-Infra Sandbox configuration from environment
        agent_infra_url = os.environ.get("AGENT_INFRA_URL", "http://localhost:8090")
        agent_infra_timeout = float(os.environ.get("AGENT_INFRA_TIMEOUT", "60"))
        ...
        return cls(
            ...
            agent_infra_url=agent_infra_url,
            agent_infra_timeout=agent_infra_timeout,
        )
    ...
    def has_agent_infra(self) -> bool:
        """Check if Agent-Infra sandbox URL is configured."""
        return self.agent_infra_url is not None
