...
from backend.src.module.dev.coder import coder_node
from backend.src.module.dev.executor import executor_node
from backend.src.module.dev.verifier import verifier_node
from backend.src.module.dev.planner import planner_node
...
def _build_base_graph():
    ...
    # Code generation (includes researcher subagent)
    builder.add_node("coder", coder_node)
    
    # Execution and testing (includes debugger subagent)
    builder.add_node("executor", executor_node)
    
    # Verification (includes reviewer subagent)
