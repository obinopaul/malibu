---
name: spreadsheets
description: Comprehensive spreadsheets manipulation toolkit for creating, editing, analyzing, and visualizing spreadsheets. When Claude needs to create a new workbook/sheet with proper formulas, cell/number formatting, and structured layout, or modify an existing workbook without breaking existing formulas or references, or visualize data with in-sheet charts/tables and sensible formatting.
---
