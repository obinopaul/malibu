...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MALIBU_CALLER", () => {
    process.env["MALIBU_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MALIBU_CALLER", () => {
    process.env["MALIBU_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MALIBU_CALLER", () => {
    process.env["MALIBU_CALLER"] = "unknown"
