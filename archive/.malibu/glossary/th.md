...
- PR #10809: https://github.com/anomalyco/malibu/pull/10809
- PR #11496: https://github.com/anomalyco/malibu/pull/11496

## Do Not Translate (Locale Additions)

- `Malibu` (preserve casing in prose; keep `malibu` only in commands, package names, paths, or code)
- `Malibu CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
