...
- PR #15835: https://github.com/anomalyco/malibu/pull/15835

## Do Not Translate (Locale Additions)

- `Malibu` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `malibu` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Malibu` in prose, `malibu` only for exact technical identifiers
...
- Avoid changing `malibu` to `Malibu` inside commands, URLs, package names, or code literals
