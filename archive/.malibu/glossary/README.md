...
Use this folder for locale-specific translation guidance that supplements `.malibu/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/malibu/pull/12345

## Do Not Translate (Locale Additions)

- `Malibu` (preserve casing)
