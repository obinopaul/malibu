...
**Only** add if it's specifically about the Desktop application or `malibu web` view. **Do not** add for terminal, TUI, or general malibu issues.
...
**Only** add if the issue mentions "zen" or "malibu zen" or "malibu black".

If the issue doesn't have "zen" or "malibu black" in it then don't add zen label
...
- jlongster for malibu server + API feature work (tool currently remaps jlongster -> thdxr until assignable)
