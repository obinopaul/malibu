...
- PR #13942: https://github.com/anomalyco/malibu/pull/13942

## Do Not Translate (Locale Additions)

- `Malibu` (preserve casing in prose; keep `malibu` only when it is part of commands, package names, paths, or code)
- `Malibu Zen`
- `Malibu CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `malibu` in prose when referring to the product name; use `Malibu`
